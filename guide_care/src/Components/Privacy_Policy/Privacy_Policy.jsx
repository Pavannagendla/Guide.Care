      ...
      <div className='container-fluid'>
        <div className='row mt-5 pt-5'>
          <div className='col-md-12'>
            ...
            <p>We ("Guidecare") recognise that your privacy is very important and take it seriously. This Privacy Policy ("Privacy Policy") sets out how we collect, use and disclose your data when you use our website https://Guidecare.com ("Website") and/or mobile application called Guidecare ("App"). The Website and App are collectively referred to as the "Platform". References to "we", "our" or "us" or the "Company" shall mean the Platform and/or Mohalla Tech Pvt. Ltd. Any references to "you", "your" or "user" shall mean any person or entity using our Platform. We will not use or share your information with anyone except as described in this Privacy Policy.</p>
            <p>This Privacy Policy is a part of and is to be read with the Guidecare Terms of use ("Terms") and our Guidecare Cookie Policy. By using this Platform, you agree to the terms and conditions of this Privacy Policy. You also consent to our use and disclosure of your Personal Information (as defined below) in the manner described in this Privacy Policy. The capitalized words used in this Privacy Policy but not defined herein, shall have the meaning given to such words in the Terms. If you do not agree with the terms and conditions of this privacy policy, please do not use this platform.</p>
            ...
            <h2>Content visible to others</h2>
            <p>Public content i.e. any content you post on your user profile or on another user’s profile, such as a post comment, is accessible to everyone, including search engines. Any information you voluntarily disclose for posting to the Platform, including your profile page information, is accessible to anyone. When you submit, post or share the content that you choose to make public, on the Platform, it may be re-shared by others. You should consider who you choose to share it with, because people who can see your activity on our Platform can choose to share it with others on and off our Platform, including people outside the audience you shared it with. For example, when you share a post or send a message to specific users of our Platform or accounts, they can download or re-share that content with other users across or off our Platform. Also, when you comment on someone else's post or like their content, your comment or like is visible to anyone who can see the other person's content. Please note that you also have the option to make your profile private in order to ensure that only followers approved by you can see your posts. Please refer to the FAQ section available at https://help.Guidecare.com/faq/private-profile for detailed information with respect to the Private Guidecare feature on the Platform.</p>
            <p>Users can also use our Platform to create and share content about you with the audience that they choose, such as posting a photo of you, or tagging you in any of their posts. We reserve the right to share all public content on any social media site or any other online or offline platform. We will never rent or sell your Personal Information to third parties, except on an anonymized basis, unless expressly provided in these Terms.</p>
            <p>Sharing with our group of companies</p>
            <p>We may share your Personal Information with any member of our Group. The term "Group" shall mean any entity that is controlled by us, or any entity that is in control of us, or any entity that is under common control with us, whether directly or indirectly.</p>
            <h2>What you share with Others</h2>
            <p>When you share content and communicate using our Platform, you choose the audience for what you share. For example, when you post any content from our Platform on Facebook, you select the audience for the post, such as a friend, a group of friends or all of your friends. Similarly, when you use WhatsApp or any other application on your mobile device to share the content on our Platform, you choose who you share the content with. We do not control and shall not be liable for the manner, in which such persons (with whom you choose to share content via any sharing options, such as WhatsApp or Facebook, available on the Platform) use the information that you share with them.</p>
            <h2>Sharing with Third Parties</h2>
            <p>We may share your information (including Personal Information) with select third parties including:</p>
            <ul>
            ...
            <p>We may also disclose your information (including Personal Information) to select third parties in the following circumstances:</p>
            <ul>
                ...
                <li>In order to enforce or apply our Terms and/or any other agreements.</li>
            </ul>
            ...
            <p>We store your data with Amazon Web Services cloud platform provided by Amazon Web Services, Inc. (headquartered at 410 Terry Ave. N Seattle, Washington 98109, USA) and also on Google Cloud Platform provided by Google LLC (headquartered at 1101 S Flower St, Burbank, California 91502, USA) on their servers located in India and abroad. </p>
            <h2>Changes To this policy</h2>
            <p>The Company may periodically update this Privacy Policy. Whenever we make any changes to this Privacy Policy that are important for you to know about, we will post the updated Privacy Policy at this link. It is your responsibility to keep checking this page from time to time in order to be aware of any changes made to this Privacy Policy.</p>
            <h2>Disclaimer</h2>
            ...
            <p>Guidecare has a Grievance Officer to address your concerns regarding data safety, privacy, and the Platform usage concerns. We will resolve the issues raised by you within 15 (fifteen) days from receiving them. </p>
            <p>Mr. Rajasekar</p>
            <p>Address:2nd Phase, Third Floor, 35/2, Hosur Rd, Konappana Agrahara, Electronic City, Bengaluru, Karnataka 560100.</p>
            <p>e-mail:contact@pixalive.me</p>
            <i>Note - Kindly send all user related grievances to the above mentioned email ID, in order for us to process and resolve the same in an expeditious manner.</i>
            <p>Nodal Contact Person - Mr. Rajasekar</p>
            <p>email: Rajasekar@pixalive.me</p>
            <i>Note - this email is solely for use by police and investigating agencies. This is not the correct email ID for user related issues. For all user related grievances, kindly contact us at contact@pixalive.me</i>
          </div>
        </div>
      </div>
    </div>
